...
That leaves us with option six, the weakest variant, which the remainder of this post will focus on. Although usually unsuitable to obtain persistence or privilege escalation, it is often seen in the wild. Take OceanLotus/ATP32, who at the end of 2019 have been observed to use a legitimate `rekeywiz.exe` alongside a malicious `duser.dll` [[10], [11]]. In this case, the malware embedded the legitimate software and dropped it to disk, adopting the '_bring your own LOLbin_' approach (another way of achieving the same would have been to copy the legitimate executable from the `\system32\` folder, assuming the executable hasn't been patched yet).
...
[![Screenshot of sample C code for our own version of dxgi.dll.](/assets/2020-06-22-dxgi-dll-c-code.jpg)](/assets/2020-06-22-dxgi-dll-c-code.jpg)
...
| ❌             | rmactivate_isv.exe                          | msdrm.dll                              | __AddMachineCertToLicenseStore           |
| ❌             | rmactivate_isv.exe                          | msdrm.dll                              | DllMain                                  |
| ❌             | rmactivate_ssp_isv.exe                      | CRYPTBASE.dll                          | DllMain                                  |
...
| ❌             | slui.exe                                    | PROPSYS.dll                            | PSPropertyBag_WriteDWORD                 |
...
_User Account Control_ (UAC) [[16]] was introduced in Windows Vista as a security feature, asking users for confirmation through a prompt before a process running under normal privileges is elevated to higher privileges. After users complained about getting flooded with UAC prompts when doing arbitrary tasks, Microsoft introduced _auto elevation_ in Windows 7, which automatically elevates certain processes if they are located in trusted directories (such as `c:\windows\system32` ). 
...
[![Screenshot of the above script showing an elevated prompt.](/assets/2020-06-22-winsat-dxgi-uac-bypass.jpg)](/assets/2020-06-22-winsat-dxgi-uac-bypass.jpg)
...
[2]: https://kevinalmansa.github.io/application%20security/DLL-Proxying/
[3]: https://docs.microsoft.com/en-us/windows/win32/dlls/dynamic-link-library-search-order
[4]: http://www.hexacorn.com/blog/2013/12/08/beyond-good-ol-run-key-part-5/
[5]: https://docs.microsoft.com/en-gb/windows/win32/sbscs/application-manifests
[6]: https://docs.microsoft.com/en-gb/windows/win32/dlls/dynamic-link-library-redirection
[7]: https://www.fireeye.com/content/dam/fireeye-www/global/en/current-threats/pdfs/rpt-dll-sideloading.pdf
[8]: https://attack.mitre.org/techniques/T1218/
[9]: https://www.microsoft.com/security/blog/2019/09/26/bring-your-own-lolbin-multi-stage-fileless-nodersok-campaign-delivers-rare-node-js-based-malware/
[10]: https://twitter.com/0xCARNAGE/status/1203882560176218113
[11]: https://any.run/report/f08ccc040c8d8db60f30a6d1026aa6523e97c6cf52b1b30f083a830a0a65a3a9/3abfc241-3ab0-4016-acbb-040b44199d52
[12]: https://docs.microsoft.com/en-us/sysinternals/downloads/procmon
[13]: https://www.nirsoft.net/utils/dll_export_viewer.html
[14]: https://www.github.com/wietze/windows-dll-hijacking/
[15]: http://www.hexacorn.com/blog/2017/07/31/the-wizard-of-x-oppa-plugx-style/
[16]: https://docs.microsoft.com/en-us/windows/security/identity-protection/user-account-control/how-user-account-control-works
[17]: https://medium.com/tenable-techblog/uac-bypass-by-mocking-trusted-directories-24a96675f6e
[18]: https://msdn.microsoft.com/en-us/library/cc751383.aspx
[19]: https://github.com/wietze/windows-dll-hijacking/blob/master/possible_windows_dll_hijacking.yml
